...
<!--   <li id="pin" ><a href="index.php?route=pd/pin/pin_tranfer&token=<?php echo $_GET['token'];?>"><i class="fa fa-dashboard fa-fw"></i> <span>Manage pin - Member</span></a></li> -->
 <li id="" ><a href="index.php?route=pd/refferal&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span> Refferal Withdrawal</span></a></li>
 <li id="" ><a href="index.php?route=pd/withdrawal&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span> User Withdrawal</span></a></li>
  <li id="pin" ><a href="<?php echo $phmenu;?>"><i class="fa fa-dashboard fa-fw"></i> <span>List InvestMent</span></a></li>
  <li id="pin" ><a href="<?php echo $ghmenu;?>"><i class="fa fa-dashboard fa-fw"></i> <span>List CashOut</span></a></li>
  <?php /* ?>
