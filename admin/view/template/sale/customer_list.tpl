            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                 ...
                 <td>Block</td>
                  ...
                  <td style="width: 140px;">Binary</td>
                  <?php /* ?>
              ...
              <tbody>
                ...
                <tr class="<?php // if($customer['hvOff'] == 1) { echo $customer['hvNew'] == true? 'hvNew ':'';} else echo 'hvOff';?>">
                  ...
                  <?php if ($customer['payment'] == 0) { ?>
                      <td class="text-left"><a class="btn btn-danger" href="<?php echo $customer["active_withdrawal"] ?>" onclick="return confirm('Are you sure?')" >Khóa</a></td>
                 <?php } else{ ?>
                     <td class="text-left"><a class="btn btn-info" href="<?php echo $customer["active_withdrawal"] ?>" onclick="return confirm('Are you sure?')" >Không khóa</a></td>
                  <?php   } ?>
                  


                  <td class="text-left"><?php echo $customer['username']; ?></td>
                  <td class="text-left"><?php echo number_format($customer['total_left']); ?></td>
                  <td class="text-left"><?php echo number_format($customer['total_right']); ?></td>
                  <td class="text-left"><?php echo number_format($customer['total_amount_left']); ?></td>
                  <td class="text-left"><?php echo number_format($customer['total_amount_right']); ?></td>
               ...
               <!--   <td class="text-left"><?php echo $customer['name_country']; ?></td>
                  ...
                  <td class="text-left"><?php echo $customer['name_binary']; ?></td>
                  <?php /*?>
                  <td class="text-left"><?php echo $customer['email']; ?></td>
