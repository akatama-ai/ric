...
<div class="container-fluid">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title">List Investment</h3>
    </div>
     		...
     		<tbody id="result_date"> 
                ...
                foreach ($pin as $value) { $stt ++?>
                  ...
                  <tr>
                    ...
                    <!-- <td><?php echo ($value['total_revice']) ?> USD</td> -->
                    <td><?php 
                ...
                <?php } ?>
                <tr>
                    <td colspan="4" class="text-right"><?php echo number_format($sum); ?> USD  USD - (<?php $url = "https://blockchain.info/tobtc?currency=USD&value=".$sum;
