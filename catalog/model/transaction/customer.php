<?php
class ModelTransactionCustomer extends Model {
	...
	/*---------------------Mezidas------------------*/
	public function sumGDtransaction(){
		$query = $this -> db -> query("
			SELECT count(*) as number
	...
	public function sumGDtransaction_you(){
		$query = $this -> db -> query("
			SELECT count(*) as number
			FROM  ".DB_PREFIX."customer_get_donation_transaction 
			WHERE customer_id = '".$this->session->data['customer_id']."'
	...
	public function getGDtransaction($limit, $offset){
		$query = $this -> db -> query("
			SELECT A.*,B.username,B.img_profile
			FROM  ".DB_PREFIX."customer_get_donation_transaction A INNER JOIN ".DB_PREFIX."customer B ON A.customer_id = B.customer_id
			ORDER BY amount ASC
			LIMIT ".$limit."
			OFFSET ".$offset."
		");
	...
	public function getGDtransaction_you($limit, $offset){
		$query = $this -> db -> query("
			SELECT A.*,B.username,B.img_profile,C.transfer_code
			FROM  ".DB_PREFIX."customer_get_donation_transaction A INNER JOIN ".DB_PREFIX."customer B ON A.customer_id = B.customer_id INNER JOIN ".DB_PREFIX."customer_transfer_list C ON A.customer_id = C.gd_id_customer
			WHERE A.customer_id = '".$this->session->data['customer_id']."'
			ORDER BY amount ASC
			LIMIT ".$limit."
			OFFSET ".$offset."
		");
	...
	public function sumPDtransaction(){
		$query = $this -> db -> query("
			SELECT count(*) as number
	...
	public function sumPDtransaction_you(){
		$query = $this -> db -> query("
			SELECT count(*) as number
			FROM  ".DB_PREFIX."customer_provide_donation_transaction	
			WHERE customer_id = '".$this->session->data['customer_id']."'
	...
	public function getPDtransaction($limit, $offset){
		$query = $this -> db -> query("
			SELECT  A.*,B.username,B.img_profile
			FROM  ".DB_PREFIX."customer_provide_donation_transaction A INNER JOIN ".DB_PREFIX."customer B ON A.customer_id = B.customer_id
	...
	public function getPDtransaction_you($limit, $offset){
		$query = $this -> db -> query("
			SELECT  A.*,B.username,B.img_profile
			FROM  ".DB_PREFIX."customer_provide_donation_transaction A INNER JOIN ".DB_PREFIX."customer B ON A.customer_id = B.customer_id
			WHERE A.customer_id = '".$this->session->data['customer_id']."'
	...
	public function create_buy($customer_id,$amount,$price,$numbtc){
			$query = $this -> db -> query("
			INSERT INTO " . DB_PREFIX . "customer_get_donation_transaction SET
				amount = ".$amount.",
				customer_id = ".$customer_id.",
				price = '".$price."',
				date_added = NOW(),
			...
			$query = $this -> db -> query("
			UPDATE " . DB_PREFIX . "customer_get_donation_transaction SET
				gd_number = '".$gd_number."'
				WHERE id = '".$gd_id."'
			");
			$data['gd_number'] = $gd_number;
	...
	public function create_sell($customer_id,$amount,$price,$numbtc){
			$query = $this -> db -> query("
			INSERT INTO " . DB_PREFIX . "customer_provide_donation_transaction SET
				amount = ".$amount.",
				customer_id = ".$customer_id.",
				price = '".$price."',
				date_added = NOW(),
			...
			$query = $this -> db -> query("
			UPDATE " . DB_PREFIX . "customer_provide_donation_transaction SET
				pd_number = '".$gd_number."'
				WHERE id = '".$gd_id."'
			");
			$data['pd_number'] = $gd_number;
		return $data;
	}
	public function get_gd_create($gd_number){
		$query = $this -> db -> query("
			SELECT A.*,B.username,B.img_profile
			FROM  ".DB_PREFIX."customer_get_donation_transaction A INNER JOIN ".DB_PREFIX."customer B ON A.customer_id = B.customer_id
			WHERE gd_number = '".$gd_number."'
		");
		return $query -> row;
	}
	public function get_gd_tranfer($gd_number){
		
		$query = $this -> db -> query("
			SELECT A.* ,B.username,B.img_profile, C.pd_id_customer,C.pd_status,C.gd_status,C.date_added as date_added_tf,C.amount as amount_tf,C.numbtc as numbtc_tf
			FROM  ".DB_PREFIX."customer_get_donation_transaction A INNER JOIN ".DB_PREFIX."customer B ON A.customer_id = B.customer_id LEFT JOIN ".DB_PREFIX."customer_transfer_list C ON A.customer_id = C.gd_id_customer
			WHERE A.gd_number = '".$gd_number."'
		");
		return $query -> row;
	}
	public function get_pd_create($pd_number){
		$query = $this -> db -> query("
			SELECT A.*,B.username,B.img_profile
			FROM  ".DB_PREFIX."customer_provide_donation_transaction A INNER JOIN ".DB_PREFIX."customer B ON A.customer_id = B.customer_id
	...
	public function getCustomer_wallet($customer_id) {
		$query = $this -> db -> query("
			SELECT * FROM ". DB_PREFIX . "customer_wallet_blockio  WHERE customer_id = '" . (int)$customer_id . "'"
		);
		return $query -> row;
	}
	public function create_tranfer($data){
		$this -> db -> query("
	...
	public function get_tranferlist($transfer_code) {
		$query = $this -> db -> query("
			SELECT * FROM ". DB_PREFIX . "customer_transfer_list   WHERE transfer_code = '" .$transfer_code . "'"
		);
		return $query -> row;
	}
	public function get_tranferlist_buy($transfer_code) {
		$query = $this -> db -> query("
			SELECT *,A.amount as amount_tf,A.date_added as date_added_tf FROM ". DB_PREFIX . "customer_transfer_list A INNER JOIN  ". DB_PREFIX . "customer B ON A.gd_id_customer = B.customer_id INNER JOIN ". DB_PREFIX . "customer_wallet_blockio C ON A.gd_id_customer = C.customer_id  WHERE transfer_code = '" .$transfer_code . "'"
		);
		return $query -> row;
	}
	...
	public function get_pd_username($id_pd){
		$query = $this -> db -> query("
			SELECT A.*,B.username,B.img_profile
			FROM  ".DB_PREFIX."customer_provide_donation_transaction A INNER JOIN ".DB_PREFIX."customer B ON A.customer_id = B.customer_id
			WHERE id = '".$id_pd."'
	...
	public function update_status_tranferlist_pd($transfer_code,$pd_status){
		$query = $this -> db -> query("
			UPDATE " . DB_PREFIX . "customer_transfer_list SET
				pd_status = '".$pd_status."'
	...
	public function update_status_tranferlist_gd($transfer_code,$gd_status){
		$query = $this -> db -> query("
			UPDATE " . DB_PREFIX . "customer_transfer_list SET
				gd_status = '".$gd_status."'
				WHERE transfer_code = '".$transfer_code."'
	...
	public function update_status_gd($id_gd,$gd_status){
		$query = $this -> db -> query("
			UPDATE " . DB_PREFIX . "customer_get_donation_transaction SET
				status = '".$gd_status."'
				WHERE id = '".$id_gd."'
	...
	public function update_status_pd($id_pd,$pd_status){
		$query = $this -> db -> query("
			UPDATE " . DB_PREFIX . "customer_provide_donation_transaction SET
				status = '".$pd_status."'
				WHERE id = '".$id_pd."'
	...
	public function update_Mezidas($customer_id,$amount,$add=false){
		if ($add){
			
			$query = $this -> db -> query("
			UPDATE " . DB_PREFIX . "customer_wallet_Mezidas SET
	...
	public function get_wallet_Mezidas(){
		$query = $this -> db -> query("
			SELECT *
			FROM  ".DB_PREFIX."customer_wallet_Mezidas 
			WHERE customer_id = '".$this->session->data['customer_id']."'
		");

		return $query -> row;
	}
	public function get_wallet_blockio(){
		$query = $this -> db -> query("
			SELECT *
			FROM  ".DB_PREFIX."customer_wallet_blockio 
			WHERE customer_id = '".$this->session->data['customer_id']."'
		");
	...
	public function getTotalHistory($customer_id){
		$query = $this -> db -> query("
			SELECT count(*) AS number 
			FROM ".DB_PREFIX."customer_transaction_history_transaction
