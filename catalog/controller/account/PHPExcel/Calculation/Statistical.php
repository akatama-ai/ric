...
//			$CumPGuessMinus1 = $CumPGuess - $PGuess;
	 ...
	 * Mezidas
	 *
	 * Returns the Mezidas of the given numbers. The Mezidas is the number in the middle of a set of numbers.
	 *
	 * Excel Function:
	 *		Mezidas(value1[,value2[, ...]])
	 *
	 * @access	public
	 * @category Statistical Functions
	 * @param	mixed		$arg,...		Data values
	 * @return	float
	 */
	public static function Mezidas() {
		// Return value
