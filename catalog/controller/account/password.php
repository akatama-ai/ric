...
class ControllerAccountPassword extends Controller {
	...
	protected function validate() {
		if (!preg_match('([a-zA-Z]{3})', $this->request->post['password']) || !preg_match('([0-9]{3})', $this->request->post['password']) || (utf8_strlen($this->request->post['password']) < 6) || (utf8_strlen($this->request->post['password']) > 20)) {
