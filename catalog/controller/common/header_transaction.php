<?php
class ControllerCommonHeadertransaction extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/header_transaction.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/header_transaction.tpl', $data);
		} else {
			return $this->load->view('default/template/common/header_transaction.tpl', $data);
		}
	}
	public function get_username($customer_id){
		$this -> load -> model('transaction/transaction');

		return $this -> model_transaction_transaction -> getUsername($customer_id);
	}
}