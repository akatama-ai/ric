                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered wow zoomIn" data-wow-delay="0.2s" style="margin: auto; margin-bottom: 20px; font-size: 11pt;">
                                            ...
                                            <tbody>
                                              ...
                                              <?php if ($get_tranferlist['pd_status'] == 0 && $self->session->data['customer_id'] == $get_tranferlist['gd_id_customer']) { ?>
                                              <tr>
                                              
                                                <td class="text-center" colspan="2">
                                                
                                                  <a class="btn-lg btn btn-warning" href="<?php echo $url_confirm_sell ?>">Agreed transaction</a></td>
                                                <?php } if ($get_tranferlist['pd_status'] == 1 && $self->session->data['customer_id'] == $get_tranferlist['gd_id_customer']) { ?>
                                                 <td class="text-center" colspan="2">
                                   ...
                                   <div class="col-md-6 width50">
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered wow zoomIn" data-wow-delay="0.2s" style="margin: auto; margin-bottom: 20px; font-size: 11pt;">
                                            <thead>
                                              <tr>
                                                <th colspan="2" style="background: #364150; line-height: 50px; color: #fff; font-size: 14pt;"><?php $username_gd = $self->get_pd_username($get_tranferlist['pd_id']); echo $username_gd['username'];
