                              ...
                              <div class="col-md-6 width50">
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered wow zoomIn" data-wow-delay="0.2s" style="margin: auto; margin-bottom: 20px; font-size: 11pt;">
                                            <thead>
                                              <tr>
                                                <th colspan="2" style="background: #364150; line-height: 50px; color: #fff;font-size: 16pt;"><?php $username = $self->getCustomer_buyid($get_tranferlist['gd_id_customer']); echo $username['username'] ?>
                                                  
                                                  <?php 

                                                  $username_pd = $self->getCustomer_buyid($get_tranferlist['gd_id_customer']);
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                <td>Buyer</td>
                                                <td><?php $username_gd = $self->getCustomer_buyid($get_tranferlist['pd_id_customer']); echo $username_gd['username'] ?></td>
                                              </tr>
                                              ...
                                              <tr>
                                                ...
                                                <?php if ($get_tranferlist['pd_status'] == 0) { ?>
                                                 <a href="<?php echo $url_send;?>" type="button" class="btn btn-lg btn-success">SEND</a>
                                                <?php } ?>
                                                <?php if ($get_tranferlist['pd_status'] == 1) { ?>
                                ...
                                <div class="col-md-6 width50">
                                    ...
                                    <div class="col-md-12">
                                      <table class="table table-bordered wow zoomIn" data-wow-delay="0.2s" style="margin: auto; margin-bottom: 20px; font-size: 11pt;">
                                            <thead>
                                              <tr>
                                                 <th colspan="2" style="background: #364150; line-height: 50px; color: #fff; font-size: 14pt;"><?php $username_gd = $self->get_pd_username($get_tranferlist['gd_id']); 
                                                echo $self->getCustomer_buyid($get_tranferlist['pd_id_customer'])['username'];
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <td><?php echo $self->getCustomer_wallet($get_tranferlist['pd_id_customer'])['wallet']; ?></td>
                                              </tr>
                                              <?php $getCustomer_gd = $self->getCustomer_buyid($username_gd['customer_id']) ?>
                                              <tr>
                                                <td>Telephone</td>
                                                <td><?php  echo $self->getCustomer_buyid($get_tranferlist['pd_id_customer'])['telephone'];?></td>
                                              </tr>
                                              <tr>
                                                <td>Email</td>
                                                <td><?php  echo $self->getCustomer_buyid($get_tranferlist['pd_id_customer'])['email'];?></td>
                                              </tr>
                                               <?php if ($get_tranferlist['pd_status'] == 0) { ?>
                                               <tr>
