                                                    ...
                                                    <div class="contact-form sale-purchase">
                                                        <form role="form" action="<?php echo $url_submit; ?>" method="POST" id="form_buy">
                                                          ...
                                                          <div class="form-group">
                                                              <input id="amount" data-max="<?php echo $getsell['amount'] ?>" name="amount" type="text" class="form-control input-lg" placeholder="Quantity purchased">
                                                          </div>
                                                          <p class="col-md-12 error error_amount_max">Quantity does not exceed <?php echo $getsell['amount'] ?></p>
                                                          ...
                                                          <div class="form-group">
                                                              <input id="price" value="<?php echo $getsell['price'] ?>"  name=price type="text" class="form-control input-lg" placeholder="Price" required readonly="true">
                                                          </div>
                                                          ...
                                                          <input type="hidden" name="token" value="<?php echo $getsell['pd_number'] ?>">
